...
- [PRICE_UPDATES.md](PRICE_UPDATES.md) - Price update playbook and catalog quality review.
...
2. [AI_RAG_PHASE2.md](AI_RAG_PHASE2.md) - if AI pipeline or retrieval logic changed
