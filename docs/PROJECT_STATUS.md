...
4. Lanjutkan **provider override security hardening**: validasi/allowlist URL LM Studio dan Qdrant, mitigasi SSRF, secret-safe logging, rate limiting, dan abuse controls. Pemisahan custom Qdrant URL dari secret server sudah selesai di `5af9c2b`.
